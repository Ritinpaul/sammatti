...
export default function AvatarPage() {
  ...
  return (
    <div className="h-[calc(100vh-2rem)] flex flex-col bg-brand-gray-50 rounded-[2rem] overflow-hidden m-2 border border-brand-gray-100 shadow-2xl">
      {/* Avatar Header */}
      <div className="flex items-center gap-3 md:gap-4 px-4 md:px-8 py-4 md:py-5 border-b border-brand-gray-100 bg-white/50 backdrop-blur-md flex-shrink-0 z-10">
      ...
      {/* Chat Area */}
      <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 md:py-6 space-y-6 relative">
        {messages.length === 0 && (
          <motion.div
      ...
      {/* Input Bar */}
      <div className="px-4 md:px-8 py-4 md:py-5 border-t border-brand-gray-100 bg-white/50 backdrop-blur-md flex-shrink-0 z-10">
